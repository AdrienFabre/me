      ...
      <div>
        ...
        <div className="card">
          <ScrollableAnchor id={"FEE02"}>
            ...
            >
              From Makers Software Engineering Bootcamp Head of Education -
              April 30th 2019
            </div>
          </ScrollableAnchor>
              ...
              <div className={`text show`}>
                ...
                <ul>
                  <li>
                    I can TDD anything:
                    <br />
                    "I liked that your first test was essentially an expression
                    of a working program. However, I might consider moving in
                    smaller steps by constraining the problem – for instance,
                    starting only with input frequencies divided by ve, or using
                    a step of 1. This would allow you to start providing value
                    sooner with working test cases. I really, really liked how
                    you split out your test into actual and expected variables –
                    this made your test extremely easy to read. I gave you a
                    twist performance test, and you came up with a really good
                    way to do this kind of benchmarking."
                  </li>
                  <li>
                    I can program fluently:
                    <br />
                    "You moved quickly around the command-line to get set up.
                    You were comfortable with Ruby, using effective Ruby idioms
                    to write the test and the associated method. The solution
                    you came up with to the problem – adding the result of the
                    modulus – was very intuitive and impressive. I hadn’t
                    thought of solving the problem like that."
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    directly from the user – OK, what’s the input(s)? What data
                    structure? What’s the output? What data structure?"
                  </li>
                  <li>
                    I can refactor anything:
                    <br />
                    "It was interesting that you moved on to adding the step
                    without taking a break to refactor the code you had already
                    written (for example, you retained an each loop that
                    probably should have been a map)."
                  </li>
                  <li>
                    ...
                    implementing a solution, and so on. It felt very methodical
                    indeed."
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <br />
                    "It was really good that you spent time thinking about your
                    test structure to make it readable, including the creation
                    of variables with good names to make it clear what the input
                    and outputs were. "
                  </li>
                  <li>
        ...
        <div className="card">
          <ScrollableAnchor id={"FEE01"}>
            ...
            >
              From Makers Software Engineering Bootcamp Students
            </div>
          </ScrollableAnchor>
            ...
            {selectedSection === "FEE01" ? (
              <div className={`text show`}>
                ...
                <p>
                  ...
                  – “Your process is very strong, you know what to do next,
                  doing the Feature Test and then the Unit Test. You do not
                  hesitate to modify namings and refactor your tests along you
                  are writing the code. Finally, you communicate on what you are
                ...
                <p>
                  ...
                  – “Adrien starts each of his projects with careful planing and
                  I was invited to join in before both bowling and front-end API
                ...
                <p>
                  ...
                  – “I like that you always start tackling a problem with lots
                  of planning, you are a master at diagramming and modelling.
                  This helped all our team during our final project to
                  understand our task better. I really enjoyed working with you,
                  having spent a difficult week on our Task manager app, being
                  on a deadline and having to learn several new technologies,
                  you were always positive and helped the team a lot with
                  researching.”
                </p>
                <p>
                  <a
                  ...
                  – “It was a real pleasure working with you on our final
                  project at Makers. You were so dedicated, your thoughts were
                  very organised, and it was so helpful the way you diagrammed
                  the options we had and plans/routes we can follow to deliver
                  the required feature. You were also a great team player, with
                ...
                <p>
                  ...
                  – “Adrien was a pleasure to work with throughout the Makers
                  BnB project, he handled the pressures of new technologies and
                  the first taste of software development group work with ease.
                  When faced with questions with the new concepts he was the
                  first to press for clarification often to the benefit of the
                  wider group. Equally at ease pairing and working solo, Adrien
                  could always be relied upon to meet sprint goals.”
                </p>
                <p>
                  <a
                  ...
                  stuck. You were also very diligent in keeping your classes
                  very flexible, for example lifting out the prices in the
                  checkout challenge to the tests. This allowed you write a very
                  clean adaptable class, and showed me a new way to approach the
                ...
                <p>
                  ...
                  deliverables. His approach to creating new software is very
                  methodical and while we did not do as much formal TDD in this
                  project as we had hoped we were nonetheless working in a very
                  logical way together, and Adrien can take a lot of credit in
                  keeping the team aligned in that way. In the second week of
                  the project our team worked very well following Agile
                  processes and Adrien’s contribution was a key factor in
                  achieving this. He made sure that we performed the necessary
                  Agile ceremonies and that we iterated and collaborated in our
                  work. I was also glad for the quality of the planning and
                  feedback he gave to us all as we prepared the presentation and
                  demo of our product. This helped to make the last two days of
                  the project very rewarding for me personally. When it came to
