    ...
    return (
      <div>
        ...
        <div className="card">
          ...
          >
            2016 - Present - Create Social Impact Led Design Thinking Workshops
            and Events.
          </div>
          <div className={`text ${selectedSection === "EEX01" && "show"}`}>
            <p>
              The purpose of those events is to create social impact, to support
              social entrepreneurs and to raise awareness and encourage action
              around different causes, notably food sovereignty, refugee and
              education. The focus is to solve a challenge while also educate
              participants about a cause and a business theme. As Community
              Coordinator and Facilitator at MakeSense, my role is to design,
              organise and facilitate those events using design thinking
              methodologies; most of them are workshops involving 20
              participants during 3 hours.
            </p>
            <p>
              <a
              ...
              : The purpose of this event was to gather the food ecosystem in
              one place for one day, food production, consumption, distribution
              and recycling. The event took place in
              <a
              ...
              , where the grow, cook and recycle food waste. This was a full day
              event, from 9am to 9pm with up to 90 people and 200kg of food
              surplus rescued. Here is the list of activities:
            </p>
            <ul>
              <li>
              ...
              <li>
                3 Design thinking workshops Too Good To Go, BeEnriched, EatClub
              </li>
              ...
              <li>
                Cooking with food surplus with EatClub Other: Dye clothes from
                food surplus,
              </li>
            ...
            <p>
              <a
                ...
                rel="noopener noreferrer"
              >
                Education – The Shift Design thinking workshop
              </a>
            ...
            <p>Other social impact events I supported:</p>
            <ul>
              <li>
                <a
            ...
            <p>Hackathons I attended as a software developer:</p>
            <ul>
              <li>
                <a
        ...
        <div className="card">
          ...
          <div className={`text ${selectedSection === "EEX00" && "show"}`}>
            <ul>
              <li>
                Led 2 days training in Paris focused on training 30 trainers to
                deliver workshops about Innovation, Web Presence, Social
            ...
            <p>
              ...
              ' mission is to build a digital economy for all by creating the
              future workforce, now. We accelerate digital adoption for
